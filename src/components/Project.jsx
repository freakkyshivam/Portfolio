...
const Project = () => {
  const project = [
    {
      ...
      title: "Gemini-clone",
      description:
        "I built a Gemini AI clone  with features like real-time chat UI, voice/text input, and AI responses powered by external APIs. Built with modern React patterns and responsive design.",
    ...
    },
    {
      ...
      title: "AI Chat Bot",
      description:
        "Intelligent chatbot using natural language processing. Features context awareness, multi-language support, and learning capabilities.",
      image:
...

    {
      ...
      title: "News App",
      description:
        "I created a News App using React, Tailwind CSS, and a news API that displays the latest headlines with category-based filtering and responsive design.",
      image:
        "https://media.istockphoto.com/id/172763852/photo/good-news.jpg?s=612x612&w=0&k=20&c=ziVzPXpQm2qXspAQAUB8lmmmu_XrFboSjpnB8Y-6-vo=",
...

    {
      ...
      title: "Todos App",
      description:
        "A simple and intuitive Todo app built with React, allowing users to add, view, and delete tasks. It helps manage daily activities efficiently with a clean and responsive interface.",
      image:
        "https://tse2.mm.bing.net/th/id/OIP.Cp0yfRiC2nv3rqb_iBqXWwAAAA?r=0&rs=1&pid=ImgDetMain&o=7&rm=3",
...

    {
      ...
      description:
        "My personal portfolio website showcasing projects, skills, and experience. Built with modern web technologies and smooth animations.",
      image:
...

    {
      ...
      description:
        "I created a Recipe App that fetches recipes from an external API, allowing users to search and view detailed cooking instructions.",
      image:
  ...
  return (
    <section className="bg-slate-950 text-white p-5" id="project">
      <h1 className="text-3xl text-emerald-400 font-semibold text-center mb-10 mt-10">
        Projects
      </h1>
